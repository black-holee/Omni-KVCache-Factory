...
datasets = ["train_longer_than_four"]

dataset2maxlen = {
    "train_longer_than_four": 64,
}

model2prompt = {
    "train_longer_than_four": "Read the following text and answer briefly.\n\n{context}\n\nNow, answer the following question based on the above text, only give me the answer and do not output any other words.\n\nQuestion: {input}\nAnswer:",
}
...
def main(model, args):
    ...
    for i in tqdm(range(0, len(prompts), args.eval_batch_size), desc=desc_string, ncols=100):
        ...
        batch_ids = ids[i:i+args.eval_batch_size]
