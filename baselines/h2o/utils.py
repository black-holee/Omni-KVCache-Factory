...
class H2OKVCluster():
    def __init__(self, window_size = 64, max_capacity_prompt = 256 + 64, kernel_size = 5,
     ...
     retain_rate=0.25, eviction_mode="constant"):
    ...
    def reset(self, window_size = 64, max_capacity_prompt = 256 + 64, kernel_size = 5,
     pooling = 'avgpool', merge = None, retain_rate=0.25, eviction_mode="constant"):
        self.window_size = window_size
        self.max_capacity_prompt = max_capacity_prompt
        assert self.max_capacity_prompt - self.window_size > 0
        self.kernel_size = kernel_size
    ...
    def update_kv(self, key_states, query_states, value_states, attention_mask, num_key_value_groups):
        ...
        if q_len < self.max_capacity_prompt:
            ...
            attn_weights = torch.matmul(query_states, repeated_key_states.transpose(2, 3)) / math.sqrt(head_dim)
            ...
            attn_weights = attn_weights.view(bsz, -1, num_key_value_groups, q_len, q_len).sum(dim=2)
