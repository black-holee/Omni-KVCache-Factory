...
def llama_sdpa_attn_forward_StreamingLLM(*args, **kwargs):
    return llama_attn_forward_StreamingLLM(*args, **kwargs)


def llama_flash_attn2_forward_StreamingLLM(*args, **kwargs):
    return llama_attn_forward_StreamingLLM(*args, **kwargs)
